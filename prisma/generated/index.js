...
exports.Prisma.HeartRateLogScalarFieldEnum = {
  id: 'id',
...
exports.Prisma.CalorieEstimationScalarFieldEnum = {
  id: 'id',
  activityId: 'activityId',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/ridho/Projects/vector-calculus-2/prisma/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchema": "datasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"./generated\"\n}\n\nmodel User {\n  id            String            @id @default(cuid())\n  name          String?\n  email         String            @unique\n  emailVerified DateTime?\n  image         String?\n  password      String?\n  username      String?\n  accounts      Account[]\n  sessions      Session[]\n  Authenticator Authenticator[]\n  activities    ActivitySession[]\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Account {\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([provider, providerAccountId])\n}\n\nmodel Session {\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@id([identifier, token])\n}\n\n// Optional for WebAuthn support\nmodel Authenticator {\n  credentialID         String  @unique\n  userId               String\n  providerAccountId    String\n  credentialPublicKey  String\n  counter              Int\n  credentialDeviceType String\n  credentialBackedUp   Boolean\n  transports           String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([userId, credentialID])\n}\n\nmodel ActivitySession {\n  id                String             @id @default(cuid())\n  user              User               @relation(fields: [userId], references: [id])\n  userId            String\n  type              String // contoh: \"lari\", \"bersepeda\", dll\n  startedAt         DateTime\n  endedAt           DateTime\n  heartRateLogs     HeartRateLog[]\n  calorieEstimation CalorieEstimation?\n  createdAt         DateTime           @default(now())\n  updatedAt         DateTime           @updatedAt\n}\n\nmodel HeartRateLog {\n  id         String          @id @default(cuid())\n  activity   ActivitySession @relation(fields: [activityId], references: [id])\n  activityId String\n  timestamp  DateTime // waktu pengambilan detak jantung\n  heartRate  Int // dalam bpm\n}\n\nmodel CalorieEstimation {\n  id                String          @id @default(cuid())\n  activity          ActivitySession @relation(fields: [activityId], references: [id])\n  activityId        String          @unique\n  estimatedCalories Float // hasil estimasi kalori terbakar\n  method            String // misal: \"integral\", \"average\", dll\n  calculatedAt      DateTime        @default(now())\n}\n",
  "inlineSchemaHash": "5fcabe83088fdd21d2a6d70834afe884c96f089acf41bc35a321747ee7578332",
  "copyEngine": true
}
