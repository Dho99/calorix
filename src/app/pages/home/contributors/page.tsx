...
export default function Page() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between dark:text-white relative py-20 items-center">
      ...
      <div className="grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 gap-10 mt-10">
        {
          contributors.map((contributor, index) => (
            <div key={index} className="flex flex-col items-center bg-black/20 bg-white/20 p-5 rounded-lg shadow-lg transition-transform transform hover:scale-105">
