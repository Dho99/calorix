...
export default function SaveCalculate({props}: { props: StepValues }) {
    ...
    return (
        ...
        <div className="flex flex-col justify-between mb-2 text-center">
            ...
            <p className="text-white text-xl">Your BMI: {bmi as string}</p>
            <p className="text-white text-xl">Your BMR: {bmr as string}</p>
            <p className="text-white text-xl">Your TDEE: {tdee as string}</p>
        </div>
        </div>
