    ...
    return (
        ...
        <div className="bg-green-300/60 dark:bg-white/30 rounded-lg p-4 dark:text-white shadow-lg w-full h-full flex justify-center">
            <div className="flex flex-col mb-2 text-start">
                ...
                <p className="dark:text-white text-xl">BMI Anda: {Number(0 || bmi).toFixed(2) || 0}</p>
                <p className="dark:text-white text-xl">BMR Anda: {Number(0 || bmr).toFixed(2) || 0}</p>
                <p className="dark:text-white text-xl">TDEE Anda: {Number(0 || tdee).toFixed(2) || 0}</p>
                <p className="dark:text-white text-xl"> Perhitungan Kalori dari Aktivitas Fisik (MET) Awal Anda: {Number(0 || userMETValue).toFixed(2) || 0} Kalori</p>
            </div>
        </div>
