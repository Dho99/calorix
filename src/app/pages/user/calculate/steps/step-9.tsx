...
export default function Step9({updateStepState}: {updateStepState: (stepNumber: string, value: string | number | boolean) => void}) {
    return(
        <>
            <Label htmlFor="email" className="text-lg">Masukkan target Berat Badan Anda</Label>
            <input
                type="number"
