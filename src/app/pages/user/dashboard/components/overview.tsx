      ...
      <div className="w-full h-auto bg-[#1B4242] text-white rounded-lg shadow-md p-4">
        <div className="flex flex-row w-full p-3 gap-5 items-center">
            ...
            <div className="flex flex-col">
                ...
                <h1 className="text-4xl font-bold text-white mb-3">{data?.user?.name}</h1>
            </div>
        </div>
        <div className="w-full grid grid-cols-4 gap-2">
          ...
          <div className="w-full bg-[#1B4242] text-white rounded-lg shadow-md p-4">
            ...
            <p>{characteristics?.bmi && parseFloat(String(characteristics?.bmi)).toFixed(2)}</p>
          </div>
          <div className="w-full bg-[#1B4242] text-white rounded-lg shadow-md p-4">
            <h2 className="text-lg font-bold">Body Fat</h2>
            <p>{characteristics?.bodyFatPercentage && parseFloat(String(characteristics?.bodyFatPercentage)).toFixed(2)} %</p>
          </div>
        </div>
      </div>
    </div>
