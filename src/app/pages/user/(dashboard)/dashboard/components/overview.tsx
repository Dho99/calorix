...
export default function Overview({ pageData }: { pageData: OverviewProps }) {
  ...
  return (
    <div className="w-full h-full ">
      <div className="w-full h-auto bg-orange-500/40 dark:bg-[#1B4242]/70 dark:text-white rounded-lg shadow-md border dark:border-white/50 p-4 flex flex-col gap-4">
        <div className="flex lg:flex-row md:flex-row sm:flex-row flex-col w-full p-3 gap-5 items-center">
          <div className="bg-orange-500 h-28 w-28 rounded-full">
        ...
        <div className="w-full grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-2 gap-2">
          <div className="w-full bg-orange-500/40 dark:text-white rounded-lg shadow-md p-4 border border-white/50">
            <h2 className="text-lg font-bold">Weight</h2>
            <p>{Number(Number(pageData?.currentWeight) || 0).toFixed(2)} Kg</p>
          </div>
          <div className="w-full  bg-orange-500/40 dark:bg-[#1B4242] dark:text-white  rounded-lg shadow-md p-4 border border-white/50">
          ...
          <div className="w-full h-full bg-orange-500/40 dark:bg-[#1B4242] dark:text-white  rounded-lg border border-white/50 shadow-md p-4 flex flex-row gap-2 lg:col-span-2 items-center">
          ...
          <div className="w-full bg-orange-500/40 dark:bg-[#1B4242] dark:text-white rounded-lg shadow-md p-4 border border-white/50 lg:col-span-1 col-span-2">
