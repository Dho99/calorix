...
export default function DueTarget({
  ...
  return (
    <div className="w-full h-full bg-orange-500/40 dark:text-white  border border-white/50 rounded-lg shadow-md p-4 flex flex-col gap-2">
      <div className="flex lg:flex-row flex-col gap-5 items-center h-full w-full">
        <div className="bg-orange-500/40 rounded p-2 w-fit me-auto">
